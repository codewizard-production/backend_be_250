...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM be.PetService");
    jdbcTemplate.execute("DELETE FROM be.PetOwner");
    jdbcTemplate.execute("DELETE FROM be.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM be.Manager");
    jdbcTemplate.execute("DELETE FROM be.Document");
    jdbcTemplate.execute("DELETE FROM be.Pet");
     jdbcTemplate.execute("DELETE FROM be.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM be.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM be.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM be.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM be.PetCareCenterPets");
